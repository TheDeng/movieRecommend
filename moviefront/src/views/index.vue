  ...
  <div>
    ...
    <div v-show="!isLogin" class="cardContainx">
      <div class="wrapper-cardx">
        <div class="card" v-for="(item, key) in recommendList" :key="key" v-if="key<=3">
          <!--          引入资源防止403-->
          <meta name="referrer" content="no-referrer"/>
          <img :src="item.fields.cover" class="image" @click="getMovieDetail(item.pk)">
          <div>
            <p style="white-space: pre-wrap;">{{item.fields.name}}    </p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="cardContain">
      <div class="wrapper-card">
        <div class="card" v-for="(item, key) in movieList" :key="key" v-if="key>=3">
<!--          引入资源防止403-->
          <meta name="referrer" content="no-referrer"/>
          <img :src="item.fields.cover" class="image" @click="getMovieDetail(item.pk)">
          <div>
...
<!--      <div class="temp">-->
<!--&lt;!&ndash;        @click="personDetail(item.id)&ndash;&gt;-->
...
export default {
  data() {
    return {
      ...
      movieList: [],
      personList: [],
      // recommendList: [{ movieId: 1428057, name: '重返中世纪', cover: 'https://img1.doubanio.com/view/photo/s_ratio_poster/public/p1878110577.jpg' },
      //   { movieId: 1428057, name: '一声惊雷', cover: 'https://img3.doubanio.com/view/photo/s_ratio_poster/public/p2178025056.jpg' },
      //   { movieId: 1428057, name: '诸神混乱之女神陷阱', cover: 'https://img3.doubanio.com/view/photo/s_ratio_poster/public/p1775859403.jpg' },
      //   { movieId: 1428057, name: '零号嫌疑犯', cover: 'https://img3.doubanio.com/view/photo/s_ratio_poster/public/p2529453201.jpg' }],
      recommendList:[],
  ...
  mounted() {
    ...
    this.getMovie();
    // this.getPerson();
    const user = JSON.parse(localStorage.getItem('user_pk'));
    this.getRecommend(user);
  },
  methods: {
    handler() {
