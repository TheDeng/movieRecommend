            ...
            .then((res) => {
              if (res.status === 200) {
                if (res.data.code === 0) {
                  ...
                  this.data = res.data.data["fields"]
                  // console.log(JSON.stringify(this.data.user_nickname))
                  localStorage.setItem('user_pk', JSON.stringify(res.data.data.pk));
                  console.log(JSON.stringify(res.data.data.pk))
                  localStorage.setItem('token', res.data.data.fields.token);
                  // console.log(res.data.data.fields.token)
